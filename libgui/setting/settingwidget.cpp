...
void SettingWidget::setupCustomerDisplay() {
    ...
    ui->lineWelcome1->setText(Preference::getString(SETTING::CUSDISPLAY_WELCOME1, "Selamat Datang"));
    ui->lineWelcome2->setText(Preference::getString(SETTING::CUSDISPLAY_WELCOME2, "di Sultan POS"));
}
